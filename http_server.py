...
def response_method_not_allowed():
    ...
    return b"\r\n".join([
        ...
        b"",
        b"You cannot do that on this server! Sorry!"
    ])
    return b""
...
def response_path(path):
    ...
    """
    my_path = os.path.abspath("webroot")
    location = os.path.join(my_path, path[1:])
    ...
    #print(response_not_found(), "Error encountered while visiting " + path)
    raise NameError
